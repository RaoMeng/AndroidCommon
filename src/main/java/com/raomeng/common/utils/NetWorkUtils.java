package com.raomeng.common.utils;
...
public class NetWorkUtils {
    ...
    public static void openWirelessSettings() {
        BaseApplication.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) BaseApplication.getAppContext()
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseApplication.getAppContext().getSystemService(Context.WIFI_SERVICE);
